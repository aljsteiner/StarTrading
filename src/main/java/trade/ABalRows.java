...
//  static int balsLength = CUMULATIVEDECAYIX + 4; //24
  static final int RAWUNITGROWTHIX = CUMULATIVEUNITDECAYIX + 4; //28
  static final int BONUSYEARLYUNITGROWTHIX = RAWUNITGROWTHIX + 4; //32
  static final int RAWGROWTHIX = BONUSYEARLYUNITGROWTHIX + 4; //36
  static final int TRADEDGROWTHIX = RAWGROWTHIX + 4; //40
  static final int SWAPPEDGROWTHIX = TRADEDGROWTHIX + 4; //44
  static final int COMMONKNOWLEDGEIX = SWAPPEDGROWTHIX + 4; //48
  static final int NEWKNOWLEDGEIX = COMMONKNOWLEDGEIX + 1; //49
  static final int MANUALSIX = NEWKNOWLEDGEIX + 1; //50
  static final int BALSLENGTH = MANUALSIX + 1; //51
