...
// There are two contexts
  ...
  static final public String storyText
          = "         StarTrader       Version 19.66\n"
            + "Click the Settings tab to select 1 or 5 years to run or change settings  "
            + "After looking at Stats you can run more years or change Settings.  " + "\n\n"
            + "         StarTrader       Version 19,69\n"
            + "“Star Trader”; “Save the Planets”; “Trade, trade, trade”; Names of a free computer game about finances and economics and economic survival strategies created to run on windows machines that have downloaded a current version of “free java” from Oracle.  It starts with many separate economies of StarTrader ships and Planets each trying to survive.  Each planet or trader has an “economy” which is part of one of five clans.   Instead of fighting and killing one another, the game emphasizes generosity.  The initial setting of the game declares the clan with the highest generosity score, winner.  The winning clan is the clan whose planets and ships have cumulatively given the most resources,staff and knowledge manuals to ships and planets of all clans. Of course this implies that the winning clan has enough planets and ships to give the most in trading. The difficulty of the game is set so that about 10% of the planets and ships do not survive each year when that economy has insufficient resources or staff in one of the seven financial sectors.\n"
            + "\n"
            + "Planets trade surplus cargo and guests with ships, in return ships trade the cargo and guests needed by a planet to survive and grow.   With the initial settings, about 10% of planets and ships die each year.  Economies survive by trading.  \n"
            + "\n"
            + "Planets are producers, finding or growing resources and birthing new staff each year.  Ships receive surplus resources, staff and knowledge manuals and give needed resources, staff or knowledge manuals to its trading partner.  Each year each resource and staff financial sector experiences costs from all the other financial sector resources and staff, reducing the economies available resources, staff.  Each economy has 2 financial sectors that are so weak they need to receive trade resources to survive.  Each economy has 2 financial sectors that are very strong; generating resource and/or staff surpluses to be given in trade.  \n"
            + "\n"
            + "The growth of available knowledge increases the efficiency of the staff in finding and growing resources, birthing new staff and moving current staff up one or more of the 16 grades, finding new knowledge. and studying knowledge manuals to produce more common knowledge.  The increased efficiency reduces the yearly costs.  But the growth of new resources and staff causes depreciation which reduces the amount of the next years growth or finding of resources, staff and knowledge.  Only planets are producers, and only the active “resources” and “staff” produce more the reserve “cargo” and “guests” do not produce more by default.  Ships generally do not “grow” resources or staff, and yearly costs are also related to how far they traveled between planets.\n"
            + "\n"
            + "There are 59 different settings that the “game master” can change.  Each “clan master” has 41 different settings.  Many of these settings have values that differ between the planets and the ships.  The settings remain set until the end of the game or until changed again.  Settings can be “kept” in the “keep” file  to change a given setting to the keep value at the beginning of the following games.  The “game master” can change the settings of what is needed to win. The “game master” can also change the rate of growth,the rules of trading, and the costs of growth, trading, and yearly life.  This enables the “game master” to alter the universe in which the clans live, to a universe quite different from our own experienced life.  This enables you to treat the game as an economics simulator.\n"
            + "\n"
            + "Each year planets and ships go through a sequence of steps including reading the keep file and mapfile, restoring subAssets, , trading, swapping resources, possible death, growth, yearly costs and saving subAssets for the next year, saving the keep file and the AI mapfile.\n"
            + "\n"
            + "I have started to work with a little bit of AI.  This is a very restricted AI limited enough to run on personal computers.  The AI reads the mapfile history of previous games and the current game, looking at the settings used in a given situation by the winning clan, and applying “nudges” to 2 selected settings for the given situation.  I started very small as recommended by AI instructors and it will remain small because of the very limited cpu and memory size of windows laptops.\n"
            + "\n"
            + "The problem is that nudges can only apply at the start of a planet or ship year, using the data for the previous game years. In addition, each year the game nudges one setting for some of the planets or ships, and adds that into whether this nudge increases the score for that planet or ship.  The idea is to find a better setting for the planet or ship that is getting AI.  The settings are encoded 1 character for each setting or result value that is kept.  Most setting and result values are ignored to limit the number of different keys, however many random factors are applied each year so that I use a selection to find the “best” setting.  I use the “display” game tab while the game is running to watch the progression of results, and try to determine how well I am using the right selection of values so that the AI clan mostly wins.\n"
            + "\n"
            + "Before the history file, there were a lot of results kept, and other strategies in the game to try enable each planet or ship to survive and grow with the difficulty set to have about 10% of the planets and ships not survive each year.\n"
            + "\n"
            + " Resource and staff costs increase in a sector as the units of resource or staff increase.  An economy's health is determined by the initial resources and staff at the beginning of the year compared to the availability of required resources and staff, (I. E. enough food, housing, water, etc. for the year).   If health is poor, everything costs more. \n"
            + "\n"
            + "The following is an limited explanation of the inner process of the game.  This can help you change user settings for the one or more clans you control as master.  Changing settings, changes how the clan robot makes decisions about trades, swaps and growth.\n"
            + "As knowledge increases in a financial sector, that sector becomes more efficient and its costs are less.  Knowledge isdivided into each financial sector in each economy.  When trades are done, knowledge is traded as manuals, but is secondarily part of the bidding process.  The decision to accept a bid is based on whether enough of needed resources are offered for the resources requested.  Older economies have more common knowledge and can trade more manuals than newer economies.  Researchers and Faculty staff convert manuals to common knowledge, and Researchers and Faculty also generate new knowledge.  The growth of resource, staff and knowledge in each financial sector generates costs of resource and staff in each of the other financial sectors.  New staff is introduced in each financial sector as a new year 1 intern.  Each year existing staff can move 0, 1 or 2 grades higher moving through 4 intern years, 4 engineering years, 4 faculty years and 4 researcher year.  Each year a staff can generate work, teaching(increase grade), research(increase new knowledge).  Yes, I worked 41 years in IT at a university.\n"
            + "\n"
            + "Resources are mined or grown, and they get depreciated.  The more that has been mined, the less each worker produces, so that eventually the mines run out.  However, catastrophes destroy large portions of one or more resources, but then refreshes one or more other resources like new mine fields are found.  Ships do not mine, but they find large bundles of manuals that can be traded.  Manuals are turned into common knowledge by research staff each year.\n"
            + "\n"
            + "The number of 5 clans and 7 resource sectors was limited by the space for 10 columns in the result tables that would fit on a laptop monitor. \n"
            + "\n"
            + "Each of the 7 resource sectors consist of active resources and staff and inactive cargo and guests.  Inactive resources cannot be mined and inactive staff do not grow new staff (but there are settings for this).  It is cargo and guests that are traded.  The guests are in grades, and will stay in that grade if they are activated from guest\n"
            + "\n"
            + "Settings are changed by clicking the settings tab and selecting a clan color.  The gray “master” button shows the game master settings that apply to all of the clans.  The colored buttons: red, orange, yellow ,green, blue: selects the settings for the named clan.  Change settings by clicking  the end of the bar sliding it left or right.  Generally a setting of 50 is fairly neutral, left smaller numbers decrease the effect, right larger numbers increase the effect. There are separate settings for the game master and for each clan.  There are usually separate settings for planets and ships, but if there is only a planet setting, it also applies to ships.  There are only 10 settings on a page with an “up” and “down” button to move to another page.  Generally the most important settings occur first.  Settings are changed by moving the pointer on a slide.  Each setting has a name, and if you click on a name, a larger description is shown that tells somewhat about what is changed when you increase the setting.  Often it is hard to understand a setting without understanding some of the internal processes during a game year.  I try to explain what I can for each setting.  But each setting is complex.  Each year new random modifiers change the effect of the setting.  In addition the effect of a setting is affected by the health of the economy and other settings, and on the current blend of resources.  You really need to study the statistics to understand the effect of a change.  If you click the “keep” button on a page where you changed a setting.  The changed setting will be kept for following games in the “keep” file.\n"
            + "\n"
            + "In a year, each economy does the following steps, create game economies for free up to a game limit, then create clan economies based on laid aside resources, catastrophes, efficiency setting(limits costs) growth settings, compute costs, trades, swap(move resources between active and reserved status, possibly transmute/repurpose resources at high cost), check for sufficient resource (die if insufficient), do growth and the pay costs, prepare for the next year (record initial situation, results and score), start the next year or move from the display tab to the status tab after finishing the last year in the current group.\n"
            + "\n"
            + "\n"
            + "Each year after annual costs, the financial sectors with some surplus assets can increase resources and staff, find new knowledge and convert some manuals into knowledge.  Worker staff find new resources, grow new staff, and pay costs.  Faculty staff enable staff to move to a higher of 16 grades.  Researcher staff increase knowledge by  finding new knowledge and converting manuals to common knowledge, new knowledge becomes common knowledge in succeeding years.\n"
            + "\n"
            ...
            + "\n"
            + "Results, stats or statistics, are reports on the life of each clan.  There are 21 different pages of statistics.  The first 3 pages are the most useful to understand the way a high score is obtained.  The other pages offer more details about various results.\n"
            + "\n"
            ...
            + "\n"
            + "The game-master has score settings that influence the scoring, and may change the winner.  You can change your settings and continue the game even if it has picked a winner.  After more years there could be a different winner. The game master should then communicate the changes of settings to the clan-masters so they can change their clan settings to try to improve their score based on the changed master settings.\n"
            + "\n"
            + "Clan-masters can go to the settings tab and click on the link of the color of their clan, then they click on up or down or one of the ten settings being displayed for their clan.  They change their clan’s settings to try to raise their score during the next round of years, and/or try to increase the number of their planets and ships that survive.  After all clan-masters are finished, the game-master starts another round of 1, 5, 10, 20, 50 or 100 years.  \n"
            + "\n"
            ...
            + "\n"
            + "Each year economies suffer depreciation, mines start to run out, fields won’t grow as many crops etc. so that growth decreases as planets age.  Newer planets in a clan grow better than old planets.  But older planets may have more assets and still grow a larger number of assets in a year.\n"
            + "\n"
            ...
            + "\n"
            + "After each run a large set of statistics about the planets and ships is available to be viewed.  After couple of years after a death,  another ship or planet may be established at the same location. By default, between 10% to 20% of planet and ships die each year.\n"
            + "\n"
            + "At the end of the run of years the window should change to the “stats” tab.  There are 21 buttons for 21 different views of the statistics about what happened with the clan finances.  There are also buttons to run the game for 1 or 5 or 10 or 20 or 50 or 100 years.  When one of the year buttons is  clicked the screen goes back to the display tab.\n"
            + "\n"
            ...
            + "\n"
            + "The following is a guess at the loading, starting, running, and AI processes, based on the things you can do, but I have not looked at actual loading code.\n"
            + "\n"
            + "\n"
            + "\n"
            + "Install this game.  \n"
  ...
  private void initComponents() {//GEN-BEGIN:initComponents
    ...
    settingsShipLabel = new javax.swing.JLabel();
    ...
    statsButton21 = new javax.swing.JRadioButton();
    statsButton22 = new javax.swing.JRadioButton();
    ...
    displayPanel2Text1 = new javax.swing.JTextArea();
    ...
    gameToLabelPlanet.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
    ...
    settingsShipLabel.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
    settingsShipLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
    settingsShipLabel.setText("Ship");
    settingsShipLabel.setMaximumSize(new java.awt.Dimension(600, 21));
    settingsShipLabel.setMinimumSize(new java.awt.Dimension(250, 21));
    settingsShipLabel.setPreferredSize(new java.awt.Dimension(300, 21));
    game.add(settingsShipLabel, new java.awt.GridBagConstraints());
    ...
    statsButtonGroupReportNumber.add(statsButton21);
    statsButton21.setText("21");
    statsButton21.addItemListener(new java.awt.event.ItemListener() {
      public void itemStateChanged(java.awt.event.ItemEvent evt) {
        statsButton21ItemStateChanged(evt);
      }
    });
    statsButton21.addMouseListener(new java.awt.event.MouseAdapter() {
      public void mouseEntered(java.awt.event.MouseEvent evt) {
        statsButton21MouseEntered(evt);
      }
    });
    rbuttons2.add(statsButton21);

    statsButtonGroupReportNumber.add(statsButton22);
    statsButton22.setText("22");
    statsButton22.addItemListener(new java.awt.event.ItemListener() {
      public void itemStateChanged(java.awt.event.ItemEvent evt) {
        statsButton22ItemStateChanged(evt);
      }
    });
    statsButton22.addMouseListener(new java.awt.event.MouseAdapter() {
      public void mouseEntered(java.awt.event.MouseEvent evt) {
        statsButton22MouseEntered(evt);
      }
    });
    rbuttons2.add(statsButton22);
    ...
    rbuttons12Layout.setHorizontalGroup(
      ...
      .addComponent(rbuttons2, javax.swing.GroupLayout.DEFAULT_SIZE, 516, Short.MAX_VALUE)
    );
    ...
    topPaneLayout.setHorizontalGroup(
      ...
      .addGroup(topPaneLayout.createSequentialGroup()
        ...
        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        .addComponent(rbuttons12, javax.swing.GroupLayout.PREFERRED_SIZE, 520, javax.swing.GroupLayout.PREFERRED_SIZE)
        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    displayPanel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    displayPanel2.setToolTipText("primary display");
    displayPanel2.setMaximumSize(new java.awt.Dimension(2400, 1800));
    displayPanel2.setMinimumSize(new java.awt.Dimension(400, 200));
    displayPanel2.setPreferredSize(new java.awt.Dimension(1920, 1200));
    displayPanel2.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

    displayPanel2Text1.setColumns(70);
    displayPanel2Text1.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
    displayPanel2Text1.setLineWrap(true);
    displayPanel2Text1.setRows(20);
    displayPanel2Text1.setWrapStyleWord(true);
    displayPanel2Text1.setAlignmentX(0.0F);
    displayPanel2Text1.setAlignmentY(0.0F);
    displayPanel2Text1.setBorder(null);
    displayPanel2Text1.setMaximumSize(new java.awt.Dimension(2400, 1800));
    displayPanel2Text1.setMinimumSize(new java.awt.Dimension(800, 300));
    displayPanel2Text1.setName(""); // NOI18N
    displayPanel2Text1.setOpaque(false);
    displayPanel2Text1.setPreferredSize(new java.awt.Dimension(1920, 1200));
    displayPanel2.add(displayPanel2Text1);
    ...
    controlPanels.addTab("tab7", gameTopLabelShip);
  ...
  private void statsButton21ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_statsButton21ItemStateChanged
    boolean bid = statsButton21.isSelected();
    if (bid) {
      statsField.setText(statsButton20Tip);
      statsButton21.setToolTipText(statsButton20Tip);
      listRes(21, resLoops, fullRes);
    }
  }//GEN-LAST:event_statsButton21ItemStateChanged

  private void statsButton21MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_statsButton21MouseEntered
    statsButton21.setToolTipText(statsButton21Tip);
  }//GEN-LAST:event_statsButton21MouseEntered

  private void statsButton22ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_statsButton22ItemStateChanged
    boolean bid = statsButton22.isSelected();
    if (bid) {
      statsField.setText(statsButton20Tip);
      statsButton22.setToolTipText(statsButton22Tip);
      listRes(22, resLoops, fullRes);
    }
  }//GEN-LAST:event_statsButton22ItemStateChanged

  private void statsButton22MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_statsButton22MouseEntered
    statsButton22.setToolTipText(statsButton20Tip);
  }//GEN-LAST:event_statsButton22MouseEntered
  ...
  protected javax.swing.JTextArea displayPanel2Text1;
  ...
  protected javax.swing.JLabel settingsShipLabel;
  ...
  protected javax.swing.JRadioButton statsButton21;
  protected javax.swing.JRadioButton statsButton22;
  ...
  /**
   * in the annimation thread (runYears2) check the Econ state for stuck if no
   * change in stateConst,EM.curEconName,EM.wasHere; and prevState not STATS,
   * STOPPED, FATALERR, RUNSDONE
   *
   */
  void checkEconState() {
    ec = curEc = EM.curEcon;
    ...
    if (sameState && sameName && sameWh
      ...
      stateCnt = 0;
      if (E.debugThreadsOut && prevState != stateConst && (true || stateConst == CREATING || stateConst == STATS || stateConst == TRADING || prevState == RUNSDONE || prevState == STATS)) {
  ...
  /**
   * set the Econ state in the runBackgroundYears4, and check for stuck if no
   * change in stateConst,EM.curEconName,EM.wasHere and stateConstA not STATS,
   * STOPPED, FATALERR, RUNSDONE See also checkEconState for getting stuck
   *
  ...
  void runYears2() {
    try {
      ...
      for (stateCnt = 0; !EM.dfe() && !done; stateCnt++) {
        ...
        if (E.debugStatsOut2) {
          System.out.println("------NC------^^runYears2 " + sinceA() + sinceAA() + " " + stateStringNames[stateConst] + "Y" + EM.year + " cnt" + stateCnt + "::" + sameEconState);
        }
        if (E.debugStatsOut1) {
          System.out.println("----------RYa-------runYears2 " + sinceA() + sinceAA() + sinceRY2() + sinceRY3() + stateConst + " cnts" + stateCnt + "::" + sameEconState + " " + stateStringNames[stateConst] + "Y" + EM.year + (did ? " DID" : " !!DID") + (done ? " DONE" : " !!DONE"));
        }
        paintCurDisplay(ec);
        // now do waits until the next check of stateConst and paintCurDisplay
        if (E.debugStatsOut2) {
          System.out.println("----------RYb-------runYears2 " + sinceA() + sinceAA() + sinceRY2() + sinceRY3() + stateConst + " cnts" + stateCnt + "::" + sameEconState + " " + stateStringNames[stateConst] + "Y" + EM.year + (did ? " DID" : " !!DID") + (done ? " DONE" : " !!DONE"));
        }
        switch (stateConst) {
          case CONSTRUCTING:
          case CONSTRUCTED:
  ...
  Econ newEcon(double worth, int pors, int clan) {
    ...
    newEC.init(this, eM, name, clan, EM.econCnt, pors, xpos, eM.difficultyPercent[pors], worth);
   ...
   */
  public String sinceAA() {
    return since(" aaTime", aaTime);
  }
   ...
   */
  public String sinceA() {
    return since(" aTime", aTime);
  }
   ...
   */
  public String sinceRY2() {
    return since(" ry2Time", startRY2);
  }
   ...
   * @return fraction seconds since start runYears2
   */
  public String sinceRY3() {
    return since(" ry3Time", startRY3);
  }
...
//  String[][] statsData;
  ...
  public StarTrader() {
    try {
      ...
      EM.newError = true;
      eM.flushes();
      System.err.println("----STs----Err countStarTrader=" + cntInit + " " + Econ.nowName + since() + " " + Econ.nowName + " " + Econ.nowThread + " Exception " + ex.toString() + " message=" + ex.getMessage() + " " + EM.andMore());
      ex.printStackTrace(System.err);
      eM.flushes();
      setFatalError();
    }
...
//  JLabel clanLabelsP[] = {gameLabelP5, gameLabelP6, gameLabelP7, clanLabelP3, clanLabelP4};
     ...
     *
      ...
      E.sysmsg(Thread.currentThread().getName() + "StarTrader before gamePanelChange ");
      gamePanelChange(5, -2, gamePanels, gameTextFields, gameSlidersP, gameSlidersS, fullVals, curVals);
  ...
  public void doYear() {
    try {
      ...
      if (doStop || eM.dfe()) {
        ...
        yEcons = (int) (eM.minEconsMult[0][0] * (eM.envsPerYear[tyear = (eM.year < eM.lEnvsPerYear ? eM.year : eM.lEnvsPerYear - 1)]));
        //dnow = new Date();
        ...
        for (envsLoop = lEcons; envsLoop < yEcons && !eM.dfe(); envsLoop++) {
          ...
          if (E.debugCreateOut) {
            System.out.println("----CYc----" + since() + " gCreate envsLoop=" + envsLoop + " maxE=" + yEcons + " eCnt=" + eM.econCnt + " clanBias=" + clanBias + " clan=" + econClan);
          }
      ...
      if (doStop || eM.dfe()) {
        ...
        for (finishedClans = 0, clansLoop = clanBias; clansLoop < 200 && finishedClans < 5 && eM.econCnt <= eM.econLimits3[0] && !eM.dfe(); clansLoop++) {
          ...
          // now make a econ if FFunds > clanWorth for any clan
          finishedClans++; // stop  is if none of the next five have enough funds
          if (eM.clanFutureFunds[econClan] > clanWorth) {
            ...
            //      System.out.println("++++++++year" + eM.year + " " + (new Date().getTime() - EM.doYearTime) + " FFCreated " + E.clanLetter[ec.clan] + " clanCnt=" + EM.clanCnt[ec.clan] + " econCnt=" + EM.econCnt + Econ.nowName + E.clanLetter[eM.curEcon.clan] + " createWorth " + EM.mf(clanWorth) + " createdWorth=" + EM.mf(EM.curEcon.getWorth()) + " econssize=" + eM.econs.size());
      ...
      if (doStop || eM.dfe()) {
        ...
        for (shipsLoop = eM.ships.size() - 1; shipsLoop >= 0 && !eM.dfe(); shipsLoop--) {
          ...
          if (E.debugOutput) {
            System.out.println("----PT55----" + since() + " after ship barter year =" + eM.year + ", ship=" + eM.curEcon.name + (eM.curEcon.getDie() ? " is dead" : " is live"));
          }
...
//  EM.wasHere = "after startEconState ";
          ...
          EM.twh1 = new Date().getTime();
          setEconState(DOYEAREND2);
          curEc.doYearEnd2(); // finally save Map Entry
          EM.wasHere = "after EM.curEcon.doYearEnd2()";
          EM.twh1 = new Date().getTime();
          EM.econCountsTest();
          paintCurDisplay(eM.curEcon);
...
//    E.incrFracStaffForRes[1][4]++;
  ...
  synchronized void paintCurDisplay(Econ curEc) {
    ...
    try {
      ...
      int rNDepreciation = EM.DEPRECIATION;// cum ave
      ...
      if (curEc == null || EM.dfe()) {
        ...
        int diedCnt = eM.getCurCumPorsClanUnitSum(rNDied, EM.ICUM, E.P, E.S + 1, 0, 5);
        ...
        disp1 += " " + EM.econCnt + ":most" + EM.econs.size() + ":min" + cLim + ":max" + ffLim + ", Planets=" + EM.porsCnt[E.P] + " ships=" + EM.porsCnt[E.S] + " died=" + diedCnt + " /Y" + diedPerY + " "
                 + (stateConst == TRADING ? tradingEcon() : sinceEcon()) + newLine
                 ...
                 + "TradedYear " + eM.getCurCumPorsClanUnitSum(rNTraded, EM.ICUR0, E.P, E.S + 1, 0, E.LCLANS) + " " + eM.getCurCumPorsClanUnitSum(rNTraded, EM.ICUM, E.P, E.S + 1, 0, E.LCLANS) + " Planets " + eM.getCurCumPorsClanUnitSum(rNTraded, EM.ICUR0, E.P, E.P + 1, 0, 5) + " , " + eM.getCurCumPorsClanUnitSum(rNTraded, EM.ICUM, E.P, E.P + 1, 0, E.LCLANS) + " Ships " + eM.getCurCumPorsClanUnitSum(rNTraded, EM.ICUR0, E.S, E.S + 1, 0, E.LCLANS) + " , " + eM.getCurCumPorsClanUnitSum(rNTraded, EM.ICUM, E.S, E.S + 1, 0, 5) + newLine
                 ...
                 + "TradedGame " + eM.getCurCumPorsClanUnitSum(rNTraded, EM.ICUM, E.P, E.S + 1, 0, 5) + " also:" + eM.getCurCumPorsClanUnitSum(rNAlsoTraded, EM.ICUM, E.P, E.S + 1, 0, 5) + " rej:" + eM.getCurCumPorsClanUnitSum(rNRejected, EM.ICUM, E.P, E.S + 1, 0, 5) + " lost:" + eM.getCurCumPorsClanUnitSum(rNLost, EM.ICUM, E.P, E.S + 1, 0, 5) + " Planets " + eM.getCurCumPorsClanUnitSum(rNTraded, EM.ICUR0, E.P, E.P + 1, 0, 5) + " :" + eM.getCurCumPorsClanUnitSum(rNAlsoTraded, EM.ICUM, E.P, E.P + 1, 0, 5) + " :" + eM.getCurCumPorsClanUnitSum(rNRejected, EM.ICUM, E.P, E.P + 1, 0, 5) + " :" + eM.getCurCumPorsClanUnitSum(rNLost, EM.ICUM, E.P, E.P + 1, 0, 5) + " Ships " + eM.getCurCumPorsClanUnitSum(rNTraded, EM.ICUM, E.S, E.S + 1, 0, 5) + " :" + eM.getCurCumPorsClanUnitSum(rNAlsoTraded, EM.ICUM, E.S, E.S + 1, 0, 5) + " :" + eM.getCurCumPorsClanUnitSum(rNRejected, EM.ICUM, E.S, E.S + 1, 0, 5) + " :" + eM.getCurCumPorsClanUnitSum(rNLost, EM.ICUM, E.S, E.S + 1, 0, 5) + newLine
;
                 ...
                 */
        disp1 += "Difficulty" + EM.mf3(2, ":", EM.difficultyPercent[0]) + EM.mf3(2, ":", EM.difficultyPercent[1]) + " DiedGame "
        ...
        if ((tmp1 = eM.getCurCumPorsClanUnitSum(EM.STARTRCSG, EM.ICUM, E.P, E.S + 1, 0, 5)) > 0) {
          ...
          rnsos = EM.BONUSGROWTH;
          if (false && (tmp1 = eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.P, E.S + 1, 0, 5)) > 0) {
          disp1 += "CatastrophyGrowth " + eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUR0, E.P, E.S + 1, 0, 5) + ":" + eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.P, E.S + 1, 0, 5) + " /Y" + (int) (eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.P, E.S + 1, 0, 5) * invY) + " Planets " + eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUR0, E.P, E.S, 0, 5) + ":" + eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.P, E.S, 0, 5) + " /Y" + (int) (eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.P, E.S, 0, 5) * invY) + " Ships " + eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUR0, E.S, E.S + 1, 0, 5) + ":" + eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.S, E.S + 1, 0, 5) + " /Y" + (int) (eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.S, E.S + 1, 0, 5) * invY) + newLine;
        }
        rnsos = EM.DEPRECIATION;
          if (false && (tmp1 = eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.P, E.S + 1, 0, 5)) > 0) {
          disp1 += "depreciation " + eM.getSCurCumPorsClanAve(rnsos, EM.ICUR0,1, E.P, E.S + 1, 0, 5) + ":" + eM.getCurCumPorsClanValSum(rnsos, EM.ICUM, E.P, E.S + 1, 0, 5) + " /Y" + (int) (eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.P, E.S + 1, 0, 5) * invY) + " Planets " + eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUR0, E.P, E.S, 0, 5) + ":" + eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.P, E.S, 0, 5) + " /Y" + (int) (eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.P, E.S, 0, 5) * invY) + " Ships " + eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUR0, E.S, E.S + 1, 0, 5) + ":" + eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.S, E.S + 1, 0, 5) + " /Y" + (int) (eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.S, E.S + 1, 0, 5) * invY) + newLine;
        }
        rnsos = EM.ISLOW;
        if (false && (tmp1 = eM.getCurCumPorsClanUnitSum(rnsos, EM.ICUM, E.P, E.S + 1, 0, 5)) > 0) {
...
//  EM.gameVals[] fullVals = EM.gameVals.values();
  ...
  public void gamePanelChange(int clan, int action, JPanel[] panelAr, JTextField[] textFieldsAr, JSlider[] gamePSliders, JSlider[] gameSSliders, int[] unusedVals, int[] currentVals1) {
    ...
    try {
      ...
      System.out.println("-----GPC-----Enter gamePanelChange clan=" + clan + " gameClanStatus=" + eM.gameClanStatus + " action=" + action + " vvend=" + eM.vvend + " ");
      ...
      if (action == -1) { // back up a panel if possible
        if (E.debugSettingsTab) {
          System.out.print("------GPBK----backup a pannel if possible to ");
        }
        if (eM.gameClanStatus == 5) {
        ...
        if (eM.gameClanStatus == 5) {
          ...
          klan = 0;
          if (E.debugSettingsTab) {
            System.out.print("-----GRSTM----Restart at the first game master panel ");
          }
        }
        else {
          eM.cPntr = 0;
          klan = clan;
          if (E.debugSettingsTab) {
            System.out.print("-----GRSTC----Restart at the first user panel clan=" + clan);
          }
        }
        if (E.debugSettingsTab) {
          System.out.println(new Date().toString());
      ...
      while (eM.vv < eM.vvend && nn < 10) {
        ...
        if (eM.matchGameClanStatus(eM.vv)) {
          if (E.debugSettingsTab) {
            System.out.println("----GPCP----<DISPLAY clan planet " + ", desc=" + eM.valS[currentVals1[nn]][0] + ", klan=" + klan + ", line=" + nn + ", sliderV=" + eM.valI[currentVals1[nn]][eM.sliderC][eM.gamePorS][klan] + ", ww=" + currentVals1[nn] + ", clan=" + eM.gameClanStatus);
          }
          ...
          if (v > -1) {
            if (E.debugSettingsTab) {
              System.out.println("----GPSC----DISPLAY ship sliderV=" + v + ", clan=" + eM.gameClanStatus + ", klan=" + klan + ", line=" + nn + ", desc=" + eM.valS[currentVals1[nn]][0]);
            }
            // gamePSliders[nn].setForeground(Color.blue);
            ...
            if (E.debugSettingsTab) {
              System.out.println("----GPND----NO DISPLAY ship sliderv=" + v + ", clan=" + eM.gameClanStatus + ", gc=" + gc + ", klan=" + klan + ", desc=" + eM.valS[currentVals1[nn]][0]);
            }
          }
          nn++;
        }
          ...
          if (E.debugSettingsTab) {
            System.out.println("-----GPSK-----SKIP line=" + nn + ", gc=" + gc + ", klan=" + klan + ", clan=" + eM.gameClanStatus + ", desc=" + eM.valS[currentVals1[nn]][0]);
          }
        }
      ...
      if (eM.vv >= eM.vvend) {
        ...
        if (E.debugOutput) {
          System.out.println("-----GPRSTa-----start over from" + eM.vv + " panel clan=" + eM.gameClanStatus + " action=" + action + " start=" + (eM.vv = vv2) + " length=" + eM.vvend + " ");
        }
        System.out.println(new Date().toString());
      ...
      if (E.debugOutput) {
        System.out.print(
                "-----GPXT----exit gamePanelChange clan=" + eM.gameClanStatus + " action=" + action);
        System.out.println(
                " " + new Date().toString());
      }
    }
      ...
      EM.secondStack = EM.sw.toString();
      EM.newError = true;
      System.err.println("----GPER-----" + Econ.nowName + since() + " " + Econ.nowThread + "Exception " + ex.toString() + " message=" + ex.getMessage() + " " + EM.andMore());
      ex.printStackTrace(System.err);
      eM.flushes();
      eM.flushes();
      eM.flushes();
  ...
  public static void main(String args[]) throws IOException {
    ...
    try {
      ...
      if (args.length > 0 && args[0].contains("ITtest")) {
      ...
      if (testing || (args.length > 0 && ((args[0].contains("test") || (args[0].contains("t15") || args[0].contains("t35") || args[0].contains("t63") || args[0].contains("t123")))))) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
          ...
          public void run() {
            ...
            else if (args.length > 0 && (args[0].contains("run100"))) {
              st.runYears(100);
            }
            else if (args.length > 0 && (args[0].contains("run20"))) {
              st.runYears(20);
            }
      ...
      E.sysmsg("----MEa-----main finally do flushes next then close bKeep");
      EM.flushes();
      if (EM.bKeep != null) {
        EM.bKeep.close();
      }
  ...
  public static void mainStart(String args[]) throws IOException {
    try {
      ...
      if (args.length > 0) {
        System.err.println("----MSaa-----starting out in mainStart args[0]=" + args[0] + " thread=" + Thread.currentThread().getName());
      }
      else {
