...
"\n" +
"The README file is available as a doc or PDF.  I am still making some usability changes. Every month or so I insert a new version of the game, increasing the game version number. You may want to look again every two months and download a later version.  I have saved the game source at GITHUB as “StarTrader” in my “Albert Steiner” account but I haven’t yet uploaded the binary there so the game is only available in the google file mentioned above. \n" +
"\n" +
"Ignore the following instructions unless you want to try to change the source of the game.\n" +
"The source of the game is in GITHUB at albert steiner folder StarTrader.  Use Apache Netbeans to clone or download StarTrader, go to src.java.trade. (for all the source files)\n" +
"I use Apache Netbeans, the latest version, and the latest java jdk-19.0.2 version of openJDK.  Here are many of the settings you will need  in Apache NetBeans currently version 16.  You must be logged in as a windows administrator to have the windows permissions to install NetBeans.  \n" +
"\n" +
"Once you have installed NetBeans and downloaded the source files:\n" +
"1.Left Click the NetBeans Tools menu and select Java Platforms, click \"Add Platform...\" browse to C:\\Program Files\\Java and choose the latest installed jdk-19.0.2 \n" +
"2.Open NetBeans IDE and create a new maven project with the existing source\n" +
"3.Create a source folder such as C:\\Users\\Public\\netbeans\\StarTraderMaven-\n" +
...
"6.Right click the project name, select properties, select formatting, select project specific options, choose Java language, choose Tabs And Indents, Enable Indentation, Expand Tabs to Spaces, Number of Spaces per indent=2, tab Size = 2, Right Margin=80,Line Wrap After words\n" +
